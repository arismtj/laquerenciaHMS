...
const roomTypes = [
    ...
    { title: "Doble", value: "doble" },
    { title: "Triple", value: "triple" },
    { title: "Cuadruple", value: "cuadruple" },
    { title: "Quintuple", value: "quintuple" },
    { title: "Sextuple", value: "sextuple" },
...
const hotelRoom = {
    ...
    fields: [
        defineField({
            ...
            title: "Name",
            type: "string",
            validation: Rule => Rule.required().max(50).error('Maximun 50 Characters'),
        }),
